...
class SelectAccountPageState extends State<SelectAccountPage> {
  ...
  List<ReceiverModel> receivers = [
    ReceiverModel('Niraj', '8669818605', '1234 5678 4354 0909'),
    ReceiverModel('don', '8669818605', '1234 0000 4334 0909'),
    ReceiverModel('sanket', '8669818605', '1234 3445 5543 0909'),
    ReceiverModel('carry', '8669818605', '1234 0000 2234 0909'),
    ReceiverModel('beastboy', '8669818605', '5678 2344 7654 0909'),
  ];
